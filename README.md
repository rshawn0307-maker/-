...
| Skill | 一句话说明 | 讲解 |
| --- | --- | --- |
| [gongkao-interview-question](#gongkao-interview-question) | 公考面试结构化讲义全产品工具（6 个工作流） | [查看](#gongkao-interview-question) |
...
| [pe-exam-analogy-lecture](#pe-exam-analogy-lecture) | 教师编笔试"举一反三"讲稿生成与反例沉淀 | [查看](#pe-exam-analogy-lecture) |
| [pe-trial-script-generator](#pe-trial-script-generator) | 体育试讲稿教学产物全流程生成 | [查看](#pe-trial-script-generator) |
| [structured-post-fill](#structured-post-fill) | "结构化每日一练"帖子 docx 自动生成 | [查看](#structured-post-fill) |
| [zhankai-shuoshuo-post](#zhankai-shuoshuo-post) | "展开说说"系列小红书长帖 docx 自动生成 | [查看](#zhankai-shuoshuo-post) |
...
> 提示：少数 skill 依赖同仓库的兄弟 skill（例如 structured-post-fill、zhankai-shuoshuo-post 依赖 human-writing，ima-skill 供多个 skill 调用），建议一起安装到同一个 skills 根目录。
