...
> **来源声明**：本 skill 收录自 [chuspeeism/dashi-ppt-skill](https://github.com/chuspeeism/dashi-ppt-skill)（作者：chuspeeism），保留原作者内容，感谢原作者。上游采用 AGPL-3.0 许可。上游更新可用仓库根目录 `scripts/sync-dashi.sh` 一键同步。
